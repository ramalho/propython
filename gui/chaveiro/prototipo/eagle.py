...
# Changed: $LastChangedBy: barbieri $ at $LastChangedDate: 2007-09-19 22:07:39 -0300 (Wed, 19 Sep 2007) $
...
class Password( Entry ):
    ...
    def __init__( self, id, label="", value="", callback=None,
        ...
        @param expand_policy: how this widget should fit space, see
               L{ExpandPolicy.Policy.Rule}.
        """
        Entry.__init__( self, id, label, value, callback, 
                        editable, persistent, expand_policy=expand_policy,
                        active=active, visible=visible)
